...
class NioServer extends Thread {
	...
	/** the logger instance. */
	private static final bestan.common.log.Logger logger = LogManager.getLogger(NioServer.class);
	...
	public void run() {
		while (keepRunning) {
			try {
				...
				// by lxw ��Ҫ�Ż� ����ѡ�õ���Epoll LT(ƽ��ģʽ)--����Ϊֻ����һ�ζ��һ���8192��
				// �Ƿ��ΪET(��ԵģʽЧ�ʸ�)--��Ҫ����ȥ��ȡ֪������ soket inputbuffer ����
	...
	private Selector initSelector() throws IOException {
		...
		serverChannel.socket().bind(isa, 128);
		...
		//by lxw ��Ҫ�Ż� socket SO_COLSE SO_VAL ����Ҫ�޸� ��������close��4������ �ĳ�RST����
