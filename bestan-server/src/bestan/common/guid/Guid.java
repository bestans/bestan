...
public final class Guid {
	 ...
	 * login server ID 16位
	 */
	private static final long GUID_SERV_ID = 0xFFFF000000000000L;

	/**
	 * 
	 */
	private static final long GUID_CLEAR_SERV_ID = 0x0000FFFFFFFFFFFFL;
	
	/**
	 * 
	 */
	private static final char GUID_SERV_ID_SHIFT = 48;
...
//	 * 
//	 */
//	public Guid(short worldid, short logicid, char type, char firstsubtype, char secondsubtype, int uniqueid) {
//		this.value = (((worldid & GUID_MAX_VALUE) << GUID_SERV_ID_SHIFT) & GUID_SERV_ID) |
//				(((logicid & GUID_MAX_VALUE) << GUID_LOGIC_ID_SHIFT) & GUID_LOGIC_ID) |
//				(((type & GUID_MAX_VALUE) << GUID_TYPE_ID_SHIFT) & GUID_TYPE_ID) |
//				(((firstsubtype & GUID_MAX_VALUE) << GUID_SUB_TYPE_ID_SHIFT) & GUID_SUB_TYPE_ID) | 
//				(((secondsubtype & GUID_MAX_VALUE) << GUID_SECOND_SUB_TYPE_ID_SHIFT) & GUID_SECOND_SUB_TYPE_ID) |
//				((uniqueid) & GUID_MAX_UNIQUE_ID);
//				
//	}
...
//	 * 
//	 */
//	public Guid(short worldid, short logicid, char type, short megetype, int uniqueid){
//		this.value = (((worldid & GUID_MAX_VALUE) << GUID_SERV_ID_SHIFT) & GUID_SERV_ID) |
//				(((logicid & GUID_MAX_VALUE) << GUID_LOGIC_ID_SHIFT) & GUID_LOGIC_ID) |
//				(((type & GUID_MAX_VALUE) << GUID_TYPE_ID_SHIFT) & GUID_TYPE_ID) |
//				(((megetype & GUID_MAX_VALUE) << GUID_MERGE_SUB_TYPE_ID_SHIFT) & GUID_MERGE_SUB_TYPE_ID) |
//				((uniqueid) & GUID_MAX_UNIQUE_ID);
//	}
	...
	public void setLoginServId(short servid){
		this.value = (this.value & GUID_CLEAR_SERV_ID) | (((servid & GUID_MAX_VALUE) << GUID_SERV_ID_SHIFT) & GUID_SERV_ID); 
	}
	
	public short getLoginServId(){
		return (short)((this.value & GUID_SERV_ID) >> GUID_SERV_ID_SHIFT);
	}
	
	public static short getLoginServId(final long val) {
		return (short)((val & GUID_SERV_ID) >> GUID_SERV_ID_SHIFT);
	}
	 ...
	 * @return
	 */
	public boolean isEqual(Guid inguid){
		return this.value == inguid.getValue();
	}
}